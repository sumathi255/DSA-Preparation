...
Trace Visualization
Array: [ 1 , 4 , 2 , 10 , 23 , 3 , 1 , 0 , 20 ] Window: [1, 4, 2, 10] -> sum = 17 Window: [4, 2, 10, 23] -> sum = 39 Window: [2, 10, 23, 3] -> sum = 38 Window: [10, 23, 3, 1] -> sum = 37 Window: [23, 3, 1, 0] -> sum = 27 Window: [3, 1, 0, 20] -> sum = 24 Max Sum = 39
